...
const TASK_REGISTRY = {
  'content-strategy': {
    ...
    priority: 'CRITICAL',
    prompt:
      'Create content for Director of One. Target: directors/managers who are one-person departments. Pain: overloaded with admin, no time for strategy. Solution: AI automation for routine tasks. Focus on operational efficiency.',
